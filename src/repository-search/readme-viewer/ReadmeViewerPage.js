  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <hr />
        <h3>
          <span class="badge badge-primary">Stars: {data.stars}</span>
          &nbsp;
          <span class="badge badge-secondary">Forks: {data.forks}</span>
          &nbsp;
          <span class="badge badge-warning">Issues: {data.issues}</span>
        </h3>
        <div>
